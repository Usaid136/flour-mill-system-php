...
mysqli_stmt_bind_result($stmt2, $total_customers);
mysqli_stmt_fetch($stmt2);
mysqli_stmt_close($stmt2);

$total_customers_pages = ceil($total_customers / $limit);
?>
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="customer_add.php" class="btn btn-success mb-3 btn-md">
    ...
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="customer_ledger.php?id=<?= $row['id']; ?>"
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-end mt-2">
                ...
                <?php endfor; ?>
                <li class="page-item <?php if ($page >= $total_customers_pages) echo 'disabled'; ?>">
                    <a class="page-link" href="<?php if ($page >= $total_customers_pages) echo '#';
